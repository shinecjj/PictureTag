...
public class PhotoTagDraweeView extends SimpleDraweeView implements IAttacher {

    private Attacher mAttacher;

    public PhotoTagDraweeView(Context context, GenericDraweeHierarchy hierarchy) {
    ...
    public PhotoTagDraweeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PhotoTagDraweeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setEnableScale(boolean enableScale) {
        mAttacher.setEnableScale(enableScale);
    }
